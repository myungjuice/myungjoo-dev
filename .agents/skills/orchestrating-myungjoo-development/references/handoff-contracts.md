...
작은 후속 작업과 리뷰 수정은 같은 세션에서 이어간다. 독립 마일스톤 완료, 이슈·저장소 전환
또는 맥락 품질 저하가 예상되면 새 세션을 제안하고 사용자 승인 후 handoff를 만든다. 새
세션 handoff에는 현재 등급·재판정 근거, 승인 경계, 변경·검증 증거, 남은 위험과 다음
행동을 포함한다.
