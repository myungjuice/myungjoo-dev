 ...
 * Typescript 기반의 프로젝트 다수 경험
 * Zustand, Redux 등 상태 관리 라이브러리 사용 경험
 * Styled-components, Emotion, TailwindCSS 등 다양한 스타일링 방법론에 능숙
 ...
 * Jest, React Testing Library를 활용한 테스트 코드 작성 가능
 */
`,
    'soft-skills': `
/**
 * 원활한 커뮤니케이션과 협업을 통한 팀워크 형성에 능숙
 * 기획자, 디자이너, 백엔드 개발자와의 적극적인 소통 경험
 * 사용자 경험을 고려한 UI/UX 개선에 기여한 경험
 * 유연한 사고와 문제 해결 능력을 바탕으로 이슈 대응에 능함
 * 새로운 기술과 피드백을 빠르게 수용하고 적용하는 자세
 */
`,
    bio: `
/**
 * 프론트엔드 개발자로 커리어 전환 이후 React, Next.js, Typescript 중심의 개발 경험을 쌓아왔습니다.
 * 다양한 기업에서 실무 프로젝트를 진행하며 디자인 시스템 구축, 성능 최적화, CI/CD 파이프라인 구축 등
 * 프론트엔드 개발 전반에 대한 이해와 경험을 바탕으로 협업 중심의 개발 문화를 지향합니다.
 * 새로운 기술과 도전에 두려움이 없으며, 사용자의 경험을 고려한 직관적인 UI 구현에 관심이 많습니다.
 */
`,
    interests: `
/**
 * 프론트엔드 기술 트렌드에 대한 관심이 많아 새로운 라이브러리나 도구를 빠르게 테스트해보는 편입니다.
 * 사이드 프로젝트를 통해 UI/UX 개선, 디자인 시스템 정리, 상태 관리 구조 설계 등을 실험해보며,
 * 코드 품질 향상을 위한 테스트 작성 및 코드 리뷰 문화에도 지속적인 관심을 갖고 있습니다.
 ...
 * 서울호서직업전문학교 컴퓨터정보학과 졸업
 * Java, 자료구조, DB, 네트워크 등 전산 기본 지식 보유
 ...
 * 그래도 탁구는 정말 좋아합니다. 치다 보면 시간 가는 줄 몰라요!
 * 수퍼트리 다닐 때 사내 오락시설 중에 탁구장이 있었는데, 팀원들과 자주 즐기곤 했습니다.
 */
`,
    'favorite-games': `
/**
...
/**
 * 삼겹살을 가장 좋아합니다!
 * 매운 걸 잘 못 먹지만, 이상하게 또 자주 찾게 돼요.
 * 번데기, 닭발, 산낙지처럼 징그러운(?) 음식은 좀 어려운 편입니다.
 */
`,
  },
  en: {
